...
<body>
  <div class = "container">
    <div class="jumbotron">
      <h1 class="display-4" align="center">PROYECTO DISTRIBUIDOS</h1>
      <p class="lead " align="center">Aplicacion PHP mas MySQL con contenedores</p>
      <hr class="my-4" align="center">
      <p>Muestra informacion de marcas de ropa deportiva</p>
    </div>
